...
/**
 * UserManagementPage component for displaying and managing user directories.
 * @param {Object} props
 * @param {string} props.role - The role of the users to display.
...
export default function UserManagementPage({
  ...
  useEffect(() => {
    fetchUsers();
  }, [fetchUsers]); // Re-fetch if role changes
